local color = require("theme.custom.palette").colors
local theme = {}
...
function theme.setup()
  local transparent = require("theme.custom").transparent
  local style = require("theme.custom").style
  ...
  theme.highlights = {
    ...
    NvimTreeFolderIcon = { fg = color.fg_dark },
    NvimTreeRootFolder = { fg = color.sky, bold = false },
    ...
    MiniSurround = { bg = color.dark_orange, fg = color.black },
    ...
    NoiceCompletionItemKindClass = { fg = color.dark_orange, bg = color.none },
    NoiceCompletionItemKindStruct = { fg = color.dark_orange, bg = color.none },
    NoiceCompletionItemKindEvent = { fg = color.dark_orange, bg = color.none },
    NoiceCompletionItemKindEnum = { fg = color.dark_orange, bg = color.none },
    NoiceCompletionItemKindUnit = { fg = color.dark_orange, bg = color.none },
